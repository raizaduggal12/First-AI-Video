# 🎬 Create Your First AI Video (GenAI Project)

## 👩‍💻 About the Project
This project is my hands-on experiment with **AI Video Generation** using tools like:

- Adobe Firefly  
- PixVerse  

The goal was to understand how **prompt engineering + GenAI tools** can create realistic cinematic videos.

---

## 🎯 Project Overview
In this project, I generated **3 AI videos** using detailed prompts focusing on:

- Cinematic storytelling  
- Product advertisement  
- Vlog-style realism  

Each video was created purely using **text prompts**, showcasing the power of modern GenAI tools.

---

## 🎥 Generated AI Videos

### 🌅 1. Cinematic Beach Sunset
**Prompt Used:**
...
<video src="videos/beach.mp4" controls width="600"></video>

---

### 🎒 2. Lifestyle Product Commercial
**Prompt Used:**
...
<video src="videos/backpack.mp4" controls width="600"></video>

---

### 🏃 3. Vlog-Style Running Video
**Prompt Used:**
...
<video src="videos/runner.mp4" controls width="400"></video>

---

## 🧠 Key Learnings

- ✨ Importance of **detailed prompts** (lighting, camera, mood, duration)
- 🎥 Understanding **cinematic elements** like:
  - Camera movement
  - Depth of field
  - Color grading
- 🤖 How GenAI tools interpret **natural language into visuals**
...
- Adding voice narration using AI  
- Creating longer story-based videos  
- Combining multiple clips into a short AI film  
- Exploring video editing + AI integration  

---

## 📌 Conclusion

This project helped me understand how **Generative AI is transforming content creation**.  
From just text prompts, we can now generate **cinematic-quality videos**, opening endless creative possibilities.
